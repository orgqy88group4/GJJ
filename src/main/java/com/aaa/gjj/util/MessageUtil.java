 ...
 * discription:
 * author:qcm
 * createTime:2018-12-28 18:08
 */
public class MessageUtil {
    private static final String QUERY_PATH = "https://api.miaodiyun.com/20150822/industrySMS/sendSMS";
    private static final String ACCOUNT_SID = "9e415cb8cb02498e93d461f6c953fa69";
    private static final String AUTH_TOKEN = "604087b285ec461a9ca20601fcf8cc09";

    // 根据相应的手机号发送验证码
    public static String getCode(String phone) {
        System.out.println("前台传来的手机号：="+phone);
        String rod = smsCode();
        String timestamp = getTimestamp();
        String sig = getMD5(ACCOUNT_SID, AUTH_TOKEN, timestamp);
        String tamp = "验证码为"+rod+"，您正在修改登录密码，请确认是本人操作。";
        ...
        return json.getString("respCode");
